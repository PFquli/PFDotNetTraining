...
let hoverRow = 0;
let editMode = false;
const randomLength = 5; //function callback(mutationsList, observer) {
...
jquery__WEBPACK_IMPORTED_MODULE_7___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_7___default()('#add-modal').on('hidden.bs.modal', function () {
...
function removeFromCurrentDirectoryPath() {
  let arr = currentDir.split('/'); // Check array length to ensure the root stay
